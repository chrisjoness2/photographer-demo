...
function About(){
    return (
        <div>
            ...
            <img className="AggieSelfieImg" src={me} alt="aggieselfie" />
                <p className='aboutMeDiscription'> 
                    Hello everyone and thank you for visiting my page. I wanted to let you know who you 
                    will be working with if you book with me. My name is Agatha and I am from Los Angeles, California.
